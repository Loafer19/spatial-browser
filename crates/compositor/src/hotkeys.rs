...
// downloads, history, workspaces, and the F1 help page — that must
...
// workspace lists, omnibox, switcher) lives in pages/, not here — this
// file is only "what does each shortcut do".
