// Visit tracking: every completed top-level navigation gets queued for
// the compositor to record as real browsing history
// (persistence::history — distinct from persistence::typed_history,
// which is what was actually typed into the omnibox).
